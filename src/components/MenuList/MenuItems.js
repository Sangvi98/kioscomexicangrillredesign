const menuItems = {
    ...
    FajitasMexicanas: {
        ...
        {name: 'Fajitas Cabo de Hacha - Scallops', description: '', priceLong: 'Lunch – $11.99 Dinner – $16.49'},
        {name: 'Fajitas de Pollo - Chicken breast strips', description: '', priceLong: 'Lunch – $8.49 Dinner – $12.99'},
        {name: 'Fajitas Tapatias - Beef strips', description: '', price: 'Lunch – $8.99 Dinner – $13.99'},
        {name: 'Fajitas de Camarón - 12 large shrimp ', description: '', priceLong: 'Lunch – $11.99 Dinner – $15.99'},
        {name: 'Fajitas Calamari - Grilled calamari', description: '', priceLong: 'Lunch – $11.99 Dinner – $15.99'},
        ...
        {name: 'Fajitas Vegetarianas - Grilled mixed vegetables', description: '', priceLong: 'Lunch – $7.99 Dinner – $10.99'},
        ...
        {name: 'Fajitas Carnitas - Grilled pork tips', description: '', priceLong: 'Lunch – $9.49 Dinner – $13.99'},]
    },
    ComboDinners: {
